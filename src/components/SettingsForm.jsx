...
export const SettingsForm = ({className, title, parent, optionsClass, options, state, setState, translate}) => {
      ...
      <div className={className}>
         ...
         {visibleList && <div className={`${parent}${inputClass} ${optionsClass}`}>
            {options.map((option) => 
               ...
               value={state[option.id]} onChange={e => setState({...state, [option.id]: +e.target.value})} translate={translate} />
