...
export const DetailingContent = (props) => {
   ...
   useEffect(() => {
      ...
      arrDetails.forEach(detail => addMaterial(detail, allMaterials, service, details.materials))
      details[ADDED_DETAILS].forEach(detail => addMaterial(detail, allMaterials, service, details.materials))
      arrFronts.forEach(detail => addMaterial(detail, allMaterials, service, details.materials))
      details[ADDED_FRONTS].forEach(detail => addMaterial(detail, allMaterials, service, details.materials))
      arrDvps.forEach(detail => addMaterial(detail, allMaterials, service, details.materials))
      details[ADDED_DVPS].forEach(detail => addMaterial(detail, allMaterials, service, details.materials))
      arrTabletops.forEach(detail => addMaterial(detail, allMaterials, service, details.materials))
