...
export const SpecificationItem = ({name, description, code, amount, price = 0, material, discount, change, allPrice, setPrice}) => {
   ...
   const updatePrice = (e) => {
      setPrice({...allPrice, [item.name]: +e.target.value})
   }
